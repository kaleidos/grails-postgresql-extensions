...
#### THIS BRANCH (4.X) IS FOR GRAILS 3 AND HIBERNATE 4 ####
...
[![Build Status](https://travis-ci.org/kaleidos/grails-postgresql-extensions.svg?branch=4.x)](https://travis-ci.org/kaleidos/grails-postgresql-extensions)
