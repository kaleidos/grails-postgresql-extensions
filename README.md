...
With this criteria you can check if a json field contains some value in some key. To use it just use the criteria `pgJsonEquals`:
...
* 4.2.0 - 26/Jul/2014 - Hiberate 4.x. PgJsonEquals criteria.
